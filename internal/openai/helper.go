...
const (
	// recommendedHomeDir 定义放置 openai 服务配置的默认目录.
	recommendedHomeDir = ".go-openai"

	// defaultConfigName 指定了 openai 服务的默认配置文件名.
	defaultConfigName = "openai.yaml"
)
